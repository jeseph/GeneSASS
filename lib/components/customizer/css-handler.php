 ...
 *
 * @package     GeneSASS\Boilerplate\Functions
 * @since       1.0.0
 * @author      Jeseph Meyers
 * @link        https://qcmny.com
 * @license     GNU General Public License 2.0+
 */
namespace GeneSASS\Boilerplate\Customizer;

add_action( 'wp_enqueue_scripts', __NAMESPACE__ . '\build_inline_css_settings' );
/**
...
* @since 1.0.0
*/
function build_inline_css_settings() {
